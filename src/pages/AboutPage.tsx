...
const StatCard: React.FC<{
    ...
    return (
        <FadeIn delay={delay}>
            <div ref={ref} className="bg-white dark:bg-black p-8 group hover:bg-gray-50 dark:hover:bg-dark-surface transition-all duration-300 border border-black/5 dark:border-white/5 hover:border-primary/30">
                <Icon className="w-6 h-6 mb-4 text-primary group-hover:scale-110 transition-transform duration-300" />
                <div className="text-xs font-black uppercase tracking-widest text-black/50 dark:text-white/40 mb-2">{label}</div>
        ...
        <Layout>
            ...
            <div className="bg-gray-50 dark:bg-black min-h-screen pt-32 pb-20 font-sans">
                ...
                <section className="container mx-auto max-w-7xl px-6 mb-32">
                    <div className="border-b border-black/5 dark:border-white/5 pb-20">
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-16">
                            ...
                            <div className="shrink-0 text-right select-none">
                                <div className="text-[10px] font-black uppercase tracking-[0.4em] text-black/30 dark:text-white/30 mb-2">Fondata nel</div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-24 items-start">
                        ...
                        <FadeIn delay={0.15}>
                            <div className="space-y-3">
                                <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-black/50 dark:text-white/40 mb-6">
                                    ...
                                    <div
                                        ...
                                        className={`border p-5 transition-all duration-300 group relative overflow-hidden
                                            ${s.highlight
                                                ...
                                                : 'border-black/5 dark:border-white/5 bg-white dark:bg-dark-surface hover:border-primary/20'
                                            }`}
                                    >
                                        {s.highlight && (
                    ...
                    <div className="container mx-auto max-w-7xl px-6">
                        <FadeIn>
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-[0.4em] text-black/50 dark:text-white/40">
                                    La Nostra Storia
                                </span>
                            </div>
                        ...
                        <div className="relative">
                            <div className="absolute left-[19px] md:left-[calc(theme(spacing.36)+19px)] top-0 bottom-0 w-[1px] bg-black/5 dark:bg-white/5" />
                                    ...
                                    <FadeIn key={i} delay={i * 0.08}>
                                        ...
                                        >
                                            ...
                                            <div className="hidden md:flex w-36 shrink-0 justify-end pr-10 pt-6">
                                                <span className={`text-sm font-black tabular-nums transition-colors duration-300 ${activeTimeline === i ? 'text-primary' : 'text-black/30 dark:text-white/20 group-hover:text-black/60 dark:group-hover:text-white/50'}`}>
                                                    {step.year}
                                                </span>
                                            </div>
                                            ...
                                            <div className="flex-grow pb-4 pl-6">
                                                <span className={`md:hidden text-[10px] font-black uppercase tracking-widest mb-1 block transition-colors ${activeTimeline === i ? 'text-primary' : 'text-black/40 dark:text-white/30'}`}>
                                                    {step.year}
                                                </span>
                                                <div className={`border transition-all duration-500 ${activeTimeline === i
                                                    ? 'border-primary/30 bg-white dark:bg-black'
                                                    : 'border-black/5 dark:border-white/5 bg-white dark:bg-black group-hover:border-primary/20'}`
                                                }>
                                                    <div className="p-6 md:p-8">
                                                        ...
                                                        <p className="text-sm text-black/70 dark:text-white/60 font-medium leading-relaxed mt-2">
                                                            {step.desc}
                                                        </p>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        {competenze.map((comp, i) => (
                            <FadeIn key={i} delay={i * 0.04}>
                                <div className="bg-white dark:bg-dark-surface border border-black/5 dark:border-white/5 hover:border-primary/30 p-6 md:p-8 flex gap-4 items-start group transition-all duration-300 h-full">
                ...
                <section className="container mx-auto max-w-7xl px-6 pb-20">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-px bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5">
                        {collaborazioni.map((p, i) => (
                            <FadeIn key={i} delay={i * 0.03}>
                                <div className="aspect-video bg-white dark:bg-dark-surface flex items-center justify-center p-6 group transition-all duration-300 hover:bg-gray-50 dark:hover:bg-black relative overflow-hidden">
                                    <div className="absolute inset-0 bg-gradient-to-br from-primary/0 to-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                                    <span className="text-[10px] md:text-xs font-black uppercase tracking-wider text-center text-black/60 dark:text-white/40 group-hover:text-primary transition-colors duration-300 relative z-10 leading-relaxed">
                                        {p}
                                    </span>
                                </div>
                            </FadeIn>
